    ...
    <div className="min-h-screen flex flex-col">
      ...
      <Navbar fluid className="border-b border-gray-200 bg-white">
        ...
        <div className="flex md:order-2 gap-2">
          <Button color="gray" onClick={() => navigate('/auth')}>
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" color="gray" onClick={() => navigate('/auth')}>
                {t('landing.hero.login')}
              </Button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Powerful tools to help you understand and optimize your app's performance
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-6 mt-12">
            ...
            <div className="bg-gray-50 p-5 rounded-lg text-center">
              <DollarSign className="mx-auto text-primary-600 mb-2" size={28} />
              <h4 className="font-semibold">Multi-Currency</h4>
              <p className="text-sm text-gray-600">Track revenue in 8+ currencies</p>
            </div>
            <div className="bg-gray-50 p-5 rounded-lg text-center">
            ...
            <div className="bg-gray-50 p-5 rounded-lg text-center">
              <PieChart className="mx-auto text-primary-600 mb-2" size={28} />
              <h4 className="font-semibold">Custom Dashboards</h4>
              <p className="text-sm text-gray-600">Personalized analytics views</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-primary-600 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button size="lg" color="white" onClick={() => navigate('/auth')}>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                The complete analytics solution for app developers and marketers.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">© 2025 Revenue-360. All rights reserved.</p>
