          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <div className="flex justify-between items-center mb-4">
                ...
                <Button color="gray" size="sm" className="flex items-center gap-1">
              ...
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    />
                    <Legend />
                    <Bar dataKey="revenue" name={t('dashboard.topApps.revenue')} fill="#0ea5e9" />
                    <Bar dataKey="installs" name={t('dashboard.topApps.installs')} fill="#8b5cf6" />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            </Card>
            ...
            <Card>
              ...
              <div className="overflow-x-auto">
                <Table>
                  <Table.Head>
                    <Table.HeadCell>{t('dashboard.recentCampaigns.campaign')}</Table.HeadCell>
                    <Table.HeadCell>{t('dashboard.recentCampaigns.status')}</Table.HeadCell>
                    <Table.HeadCell>{t('dashboard.recentCampaigns.spend')}</Table.HeadCell>
                    <Table.HeadCell>{t('dashboard.recentCampaigns.conversions')}</Table.HeadCell>
                    <Table.HeadCell>{t('dashboard.recentCampaigns.cpa')}</Table.HeadCell>
                  </Table.Head>
                        ...
                        <Table.Cell>
                          <Badge color={
                            campaign.status === 'active' ? 'success' :
                              campaign.status === 'paused' ? 'warning' : 'failure'
